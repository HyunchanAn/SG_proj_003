...
with st.sidebar:
    st.header("⚙️ 작업 설정")
    source_dir = st.text_input("원본 이미지 폴더 경로", value=str(project_root / "test_260420_surface"))
    target_dir = st.text_input("저장될 데이터셋 경로", value=str(project_root / "dataset" / "verified"))
